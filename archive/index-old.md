...
(data can be complex, but the handling and presentation of data needs to be understandable—shift complexity towards data, keep it away from the handling and presentation for that data. Make the handling and presentation of complex data simple and robust)
